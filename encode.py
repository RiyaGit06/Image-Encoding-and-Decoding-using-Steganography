...
def main():
	...
	# hidden + 1)
	output_path = 'img/encoded_image_anime.png'
	img_visible_path = "img/Gojo_Satoru.png"
	img_hidden_path = "img/uchiha_itachi.jpg"
...
def get_binary_pixel_values(img, width, height):
	...
	Args:
	    img:    An RGB image
	    width:  Width of the image  (28,28,3)
...
def encode(img_visible, img_hidden):
	...
	# print("vis: ",width_visible, height_visible)
	width_hidden, height_hidden = img_hidden.size
	# print("hid: ",width_hidden, height_hidden)
